...
from core.types import  Auditable, UpdateModel
...
class CRUD:
    ...
    def __read_active(self, id: int) -> SQLModel:
    ...
    def __validate_model(self, incoming_data: SQLModel, extra_data: dict) -> SQLModel:
